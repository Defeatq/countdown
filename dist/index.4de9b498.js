...
if (_jsCookieDefault.default.get('timeLeft')) setTime(_jsCookieDefault.default.get('timeLeft'));
_viewJs.UI_ELEMENTS.COUNTDOWN_TIME.addEventListener('submit', (event)=>{
    event.preventDefault();
    const endInMs = event.target.day.valueAsNumber + event.target.time.valueAsNumber - 10800000;
    if (_jsCookieDefault.default.get('timeLeft')) throw new Error('Already active');
    setTime(endInMs);
});
function setTime(end) {
    _jsCookieDefault.default.set('timeLeft', end, {
        expires: new Date(end)
    });
    _countdownJsDefault.default.timer(end, (timeLeft)=>{
        ...
        _viewJs.renderTime(timePeriodsInMs);
    });
}

},{"./view.js":"2GA9o","js-cookie":"c8bBu","countdown-js":"7PaFA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2GA9o":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "UI_ELEMENTS", ()=>UI_ELEMENTS
);
parcelHelpers.export(exports, "renderTime", ()=>renderTime
);
...
},{}],"7PaFA":[function(require,module,exports) {
'use strict';
...
},{}]},["dRf9z","4pp4s"], "4pp4s", "parcelRequire4482")
